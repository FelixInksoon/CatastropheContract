...
public static class ContractDatabase
{
    ...
    {
        AddGroup("bloodthirsty", "嗜血", "Bloodthirsty", ContractCategory.EnemyForce, "敌人造成未被格挡的伤害时，回复生命。", Node(0, 0), false, ContractApplyPhase.PreCombat,
            Tier("I", 1, "敌人造成未被格挡的伤害时，回复该伤害值 15% 的生命值", false, Fx(ContractEffectKind.EnemyUnblockedDamageLifestealPercent, 15)),
            Tier("II", 2, "敌人造成未被格挡的伤害时，回复该伤害值 30% 的生命值", false, Fx(ContractEffectKind.EnemyUnblockedDamageLifestealPercent, 30)),
            Tier("III", 3, "敌人造成未被格挡的伤害时，回复该伤害值 50% 的生命值", false, Fx(ContractEffectKind.EnemyUnblockedDamageLifestealPercent, 50)));
        ...
        AddGroup("burning", "灼伤", "Burning", ContractCategory.PlayerConstraint, "每场战斗开始时，获得脆弱和虚弱。", Node(3, 1), true, ContractApplyPhase.PreCombat,
            Tier("I", 1, "每场战斗开始时，获得 1 层脆弱和虚弱", true, Fx(ContractEffectKind.PlayerStartWithWeak, 1), Fx(ContractEffectKind.PlayerStartWithFrail, 1)),
            Tier("II", 2, "每场战斗开始时，获得 2 层脆弱和虚弱", true, Fx(ContractEffectKind.PlayerStartWithWeak, 2), Fx(ContractEffectKind.PlayerStartWithFrail, 2)),
            Tier("III", 3, "每场战斗开始时，获得 3 层脆弱和虚弱", true, Fx(ContractEffectKind.PlayerStartWithWeak, 3), Fx(ContractEffectKind.PlayerStartWithFrail, 3)));
